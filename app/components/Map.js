...
export default function Map({navigation}) {
  ...
  const submit = async (e) => {
    ...
    axios
      .post(
        configData.SERVER_URL + "routes/addRoute",
        {
          destinationName,
          originName,
          fullRouteName,
    ...
    <>
      <KeyboardAvoidingView keyboardVerticalOffset={headerHeight} style={{flex: 1}}>
            ...
            <MapView
              ...
              <MapViewDirections
                ...
                onReady={(result) => {
                  ...
                  setDistance(parseFloat(parseFloat(result.distance).toFixed(2)));
                  setDuration(parseFloat(parseFloat(result.duration).toFixed(0)));
                }}
              />
            </MapView>
          </View>
        ...
        <View style={styles.bottomBar}>
          ...
          <View style={styles.button}>
            <Pressable title="Dodaj" color={'#002f52'} onPress={submit}>
              <Image source = {require('../assets/add-plus-icon.png')} style={styles.image} tintColor="white"/>
