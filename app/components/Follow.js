...
export default function Follow({navigation, route}) {
  ...
  const getPosts = async () => {
    ...
    axios.get(configData.SERVER_URL+'user/follows/' + route.params.username, {
      headers: {'token': token}})
        .then((response) => {
          setIsLoading(false);
          ...
          <SafeAreaView style={styles.container}>
            ...
            <View>
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <Text style={styles.label}>Brak obserwowanych</Text>
              </View>
            </View> :
           <View style={styles.inner}>
             <Text style={styles.results}>Osoby obserwowane</Text>
